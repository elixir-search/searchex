defmodule Searchex.Request.Search.Bm25 do
  ...
  ## Examples
      ...
      iex> Searchex.Request.Search.Bm25.term_doc_score(2, 10, 150, 200)
      0.07362
  ...
  ## Example
      ...
      iex> Searchex.Request.Search.Bm25.uniq_doc_ids([{"term1", %{"docid1" => [2,4,5]}}])
      ["docid1"]
  ...
  ## Examples
      ...
      iex> Searchex.Request.Search.Bm25.inverse_doc_freq_of_term(:NA, 0)
      0
  ...
  ## Examples
      ...
      iex> Searchex.Request.Search.Bm25.inverse_doc_freq_of_term(100, 5)
      3.04452
  """
  ...
  ## Examples
      ...
      iex> Searchex.Request.Search.Bm25.term_freq(0, :NA)
      0

      iex> Searchex.Request.Search.Bm25.term_freq(5, 20)
      0.37931
...
"""
  ...
  ## Example
      ...
      iex> Searchex.Request.Search.Bm25.avg_doc_len(20, 40)
      0.64
